...
public class http {
    ...
    private static String url="http://192.168.1.50:8084/";
    private static HttpClient client;
    private static HttpResponse responseGet;
    private static HttpEntity resEntityGet;
    
    public static String getUsuario(String mail,boolean gps) 
    {
    ...
    HttpPost httppost = new HttpPost(url+"registro");
        ...
        try {
            ...
            Value.add(new BasicNameValuePair("gps",""+gps));
...
//      public static String getUsuarioMovil(clsUsuarioMovil entidad) 
//    {
//    client = new DefaultHttpClient();
//    HttpPost httppost = new HttpPost(url);
//
